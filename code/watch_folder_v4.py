...
class Handler(PatternMatchingEventHandler):
    def __init__(self, combine_args, automate_args, archive_args):
        ...
        self.archive_args = archive_args
    ...
    def on_created(self, event):
        if os.path.basename(event.src_path)[0] != "~":
            ...
            try:
                ...
                subprocess.run(self.archive_args)
            except:
...
def main():
    ...
    event_handler = Handler(combine_args, automate_args, archive_args)
    observer = Observer()
