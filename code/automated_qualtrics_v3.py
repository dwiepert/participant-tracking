...
def main():
    ...
    parser.add_argument("--output_path", default="/Volumes/AI_Research/Speech/ParticipantTracking/testing_v2/")
    ...
    m, master_date = get_most_recent(pat = args.output_path / 'master_database*.csv', sep="_",
    ...
    ni_df = ni_df[['MRN','FirstName','LastName', 'EmailAddress', 'Site']]
    ...
    if not ni_df.empty:
        ...
        test = ni_df.merge(master, on=['FirstName','LastName','MRN','EmailAddress', 'Site'], how='left')
